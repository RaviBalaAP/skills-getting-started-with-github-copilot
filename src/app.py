...
activities = {
    ...
    "Track and Field": {
        "description": "Run, jump, and throw in track and field events",
    ...
    "Drama Society": {
        "description": "Perform in plays and learn stagecraft and acting skills",
    ...
    "Science Olympiad": {
        "description": "Apply scientific knowledge in team competitions and experiments",
